...
_HARD_WORD_REPLACEMENTS: list[tuple[str, str, str]] = [
    ...
    # 新增（第5对初稿→定稿学习：锚索扩孔与灌浆）
    (r"自进式锚杆", "自钻式锚杆", "行业规范术语纠正"),
    (r"粒径<1mm", "粒径小于1mm", "数学符号→中文书面表述"),
    (r"减少扩孔或者不扩孔", "减少扩孔数量或者不扩孔", "补充宾语使表述完整"),
    (r"摸清楚现场真实情况", "掌握现场真实情况", "口语→正式书面语"),
    (r"具体分析制定针对性处理方案", "制定针对性处理方案", "删除冗余修饰语"),
    (r"增设观测点", "增设棱镜观测点", "明确观测设备类型"),
]
